...
abstract contract Flash is SignetStd {
    /// @notice This modifier enables a contract to access some amount only during function execution -
    ///         the amount is received by the contract before the function executes, then is sent directly back at the end.
    ///         This way, the function can utilize the liquidity during transaction execution.
